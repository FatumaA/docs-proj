...
Read more on different ways you can use the Rick and Morty API at [official docs](https://rickandmortyapi.com/documentation/) and at the [GraphQL playground](https://rickandmortyapi.com/graphql).
